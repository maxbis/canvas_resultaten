...
courses_assignments = {
    14895: {  # Course ID 1
        209778: '2024-04-21 23:59',
        209779: '2024-04-21 23:59',
        209780: '2024-04-21 23:59',
        209781: '2024-04-21 23:59',
        209782: '2024-04-21 23:59',
    },
    14156: {  # Course ID 2
        189567: '2024-04-21 23:59',
        189568: '2024-04-21 23:59',
        189569: '2024-04-21 23:59',
        189570: '2024-04-21 23:59',
        189571: '2024-04-21 23:59',
    }
}
...
def update_assignment_deadlines(courses_assignments):
    for course_id, assignments in courses_assignments.items():
        ...
        for assignment_id, new_deadline in assignments.items():
            ...
            updated_assignment = assignment.edit(assignment={'lock_at': new_deadline_dt})
            print(f"Course {course_id} - Updated Assignment {updated_assignment.id}: New Deadline {updated_assignment.lock_at}")
